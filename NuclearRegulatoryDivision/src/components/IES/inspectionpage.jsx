  ...
  return (
    <div className="bg-gray-100 text-gray-900">
      ...
      <section className="container mx-auto px-6 py-16 flex flex-col md:flex-row items-center md:items-start gap-10">
        ...
        <div className="md:w-240 border-r-4 border-indigo-300 " data-aos="fade-right">
        ...
        <div className=" flex flex-col justify-between md:w-200" data-aos="fade-left">
        <h3 className="text-center mb-5 text-4xl font-bold text-indigo-600">Conducting Regulatory Inspection</h3>
    
     <div className="p-5 mt-5 bg-black-200 border-2 border-indigo-500 rounded-xl shadow-lg">

      <div data-aos="fade-up" data-aos-delay="1500" class="max-h-[350px] overflow-y-auto p-5">
    ...
    <div className="bg-white mt-10">
      ...
      <div data-aos="fade-up" data-aos-delay="1500" class="max-h-[350px] overflow-y-auto p-4">
      <p className=" text-xl text-justify">
      The PNRI imposes enforcement actions to licensees who are found to have violated any 
      rule or regulation issued by the PNRI.   These enforcement actions are issued in the form of:
      </p>
